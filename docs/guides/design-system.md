...
- **Escalabilitat tipogràfica:** Les fonts s'integren mitjançant un sistema de _Font Mapping_ centralitzat.
...
```html
<View className="bg-white/10 border border-white/20 backdrop-blur-lg"> ... </View>
```
...
```html
<View className="shadow-lg shadow-primary/40"> ... </View>
```
